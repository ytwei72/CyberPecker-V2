...
import cyberlib_statistics as statistics
...
class ProgressReporter(Thread):
    ...
    def __init__(self, ms_manager=None):
        ...
        self.progress_info = {'all': 0,
                              'inactive': 0}

        self.ms_manager = ms_manager

        self.output_info = '@report'
    ...
    def run(self):
        ...
        while self.is_continue:
            ...
            total, inactive = statistics.get_statistic()

            self.progress_info['all'] = total
            self.progress_info['inactive'] = inactive
            _sys.stdout.write(self.output_info+str(self.progress_info)+'\n')
            _sys.stdout.flush()
